...
├── notebooks/             # Jupyter-ноутбуки (EDA, анализ данных, визуализация)
├── src/                   # Исходный код проекта
│   ├── preprocessing.py   # Скрипты очистки и предобработки текста
│   ├── models.py          # Обучение и оценка моделей (включая Optuna)
│   ├── evaluation.py      # Расчет метрик и построение графиков
│   └── bot.py             # Исходный код Telegram-бота
├── models/                # Сохраненные веса лучшей модели (XGBoost + ruBERT)
...
Детальное сравнение моделей и графики метрик представлены в ноутбуках папки `notebooks/` и в тексте курсовой работы.
